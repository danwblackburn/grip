 ...
 * Constructor
 */
ME327_AS5048A::ME327_AS5048A(byte arg_cs){
	_cs = arg_cs;
	errorFlag = false;
	position = 0;
}
 ...
 */
byte ME327_AS5048A::spiCalcEvenParity(word value){
	byte cnt = 0;
	byte i;
 ...
 */
int ME327_AS5048A::getRotation(){
	word data;
	int rotation;

	data = ME327_AS5048A::getRawRotation();
 ...
 */
word ME327_AS5048A::getRawRotation(){
	return ME327_AS5048A::read(AS5048A_ANGLE);
}
 ...
 */
word ME327_AS5048A::getState(){
	return ME327_AS5048A::read(AS5048A_DIAG_AGC);
}

/**
 * Print the diagnostic register of the sensor
 */
void ME327_AS5048A::printState(){
	word data;

	data = ME327_AS5048A::getState();
	if(ME327_AS5048A::error()){
 ...
 * register)
 */
byte ME327_AS5048A::getGain(){
	word data = ME327_AS5048A::getState();
 ...
 */
word ME327_AS5048A::getErrors(){
	return ME327_AS5048A::read(AS5048A_CLEAR_ERROR_FLAG);
}

/*
 * Set the zero position
 */
void ME327_AS5048A::setZeroPosition(word arg_position){
 ...
 */
word ME327_AS5048A::getZeroPosition(){
	return position;
}
 ...
 */
word ME327_AS5048A::read(word registerAddress){
 ...
 */
word ME327_AS5048A::write(word registerAddress, word data) {
